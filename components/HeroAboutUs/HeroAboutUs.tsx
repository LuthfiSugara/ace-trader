    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12'>
                <div className='bg-[#06333D] p-[20px] rounded-lg space-y-2'>
                    <Image src='/images/vision.png' alt='vision' width={200} height={200}  className='w-[300px] mx-auto mt-2' />
                ...
                <div className='bg-[#06333D] p-[20px] rounded-lg space-y-2'>
                    <Image src='/images/mission.png' alt='mission' width={200} height={200} className='w-[300px] mx-auto mt-2' />
