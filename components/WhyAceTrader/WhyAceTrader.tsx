        ...
        <div className='space-y-8'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                <div className='bg-[#06333D] rounded-xl overflow-hidden'>
                    <Image src='/images/your-trading-your-way.png' alt='instant funding' width={500} height={500} className='w-full' />
                ...
                <div className='bg-[#06333D] rounded-xl overflow-hidden'>
                    <Image src='/images/discipline-unlocked.png' alt='instant funding' width={500} height={500} className='w-full' />
                    <div className='p-6 space-y-3'>
